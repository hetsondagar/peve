...
const prompts = [
    ...
    // Hypotheticals
    { question: "If GitHub didn't exist, how would developers collaborate on code?", type: "open", category: "philosophy", tags: ["collaboration", "git", "platforms"] },
    { question: "What if JavaScript was never invented? What would web development look like?", type: "open", category: "philosophy", tags: ["javascript", "web", "history"] },
    { question: "If you could redesign the internet from scratch, what would you change?", type: "open", category: "philosophy", tags: ["internet", "architecture", "design"] },
    { question: "What if all programming languages disappeared except one? Which would you keep?", type: "poll", category: "philosophy", options: ["JavaScript", "Python", "C++", "Go", "Rust"], tags: ["languages", "choice"] },
    { question: "If you could add one feature to any programming language, what would it be?", type: "open", category: "philosophy", tags: ["languages", "features", "improvement"] },
    { question: "What if computers could only understand binary? How would programming change?", type: "open", category: "philosophy", tags: ["binary", "programming", "fundamentals"] },
    { question: "If you could program in any fictional language from movies/books, which would you choose?", type: "open", category: "philosophy", tags: ["fiction", "creativity", "fun"] },
    { question: "What if the internet had a maximum speed limit of 56k forever?", type: "open", category: "philosophy", tags: ["internet", "speed", "constraints"] },
    { question: "If you could only use one IDE for the rest of your career, which would it be?", type: "poll", category: "philosophy", options: ["VS Code", "IntelliJ", "Vim", "Sublime", "Other"], tags: ["ide", "tools", "choice"] },
    { question: "What if every bug you wrote would physically hurt you? How would coding change?", type: "open", category: "philosophy", tags: ["bugs", "consequences", "humor"] },
    // Humor & Fun
    { question: "What's the most cursed bug you've ever encountered?", type: "open", category: "culture", tags: ["bugs", "stories", "humor"] },
    { question: "If programming languages were people, which one would be the most annoying roommate?", type: "open", category: "culture", tags: ["languages", "personality", "humor"] },
    { question: "What's the weirdest variable name you've ever seen in production code?", type: "open", category: "culture", tags: ["naming", "code", "humor"] },
    { question: "If you had to explain programming to a 5-year-old using only food analogies, how would you do it?", type: "open", category: "culture", tags: ["explanation", "analogies", "creativity"] },
    { question: "What's the most ridiculous requirement you've ever received from a client?", type: "open", category: "culture", tags: ["clients", "requirements", "stories"] },
    { question: "If you could make one programming concept illegal, which would it be?", type: "open", category: "culture", tags: ["concepts", "frustration", "humor"] },
    { question: "What's the most creative way you've procrastinated while debugging?", type: "open", category: "culture", tags: ["procrastination", "debugging", "creativity"] },
    { question: "If you could rename any programming term to something funnier, what would it be?", type: "open", category: "culture", tags: ["terminology", "humor", "creativity"] },
    { question: "What's the most absurd error message you've ever seen?", type: "open", category: "culture", tags: ["errors", "messages", "humor"] },
    { question: "If you could add one completely useless but fun feature to any programming language, what would it be?", type: "open", category: "culture", tags: ["features", "fun", "useless"] },
    // Philosophy & Future
    ...
    // More Hypotheticals
    { question: "If you could add one superpower to any programming language, what would it be?", type: "open", category: "philosophy", tags: ["superpowers", "languages", "creativity"] },
    { question: "What if every line of code you wrote had to be approved by a committee?", type: "open", category: "philosophy", tags: ["approval", "process", "constraints"] },
    { question: "If you could only use one design pattern for the rest of your career, which would it be?", type: "poll", category: "philosophy", options: ["Singleton", "Factory", "Observer", "MVC", "Other"], tags: ["patterns", "design", "choice"] },
    { question: "What if you had to explain every algorithm you use to a non-technical person?", type: "open", category: "philosophy", tags: ["algorithms", "explanation", "communication"] },
    { question: "If you could make one programming concept completely disappear, what would it be?", type: "open", category: "philosophy", tags: ["concepts", "elimination", "frustration"] },
    { question: "What if you could only debug using print statements forever?", type: "open", category: "philosophy", tags: ["debugging", "tools", "constraints"] },
    { question: "If you had to program using only emojis as commands, how would you do it?", type: "open", category: "philosophy", tags: ["emojis", "programming", "creativity"] },
    { question: "What if every variable name had to be exactly 3 characters long?", type: "open", category: "philosophy", tags: ["naming", "constraints", "variables"] },
    { question: "If you could only use one data structure for the rest of your career, which would it be?", type: "poll", category: "philosophy", options: ["Array", "Object", "Set", "Map", "Tree"], tags: ["data structures", "choice", "constraints"] },
    { question: "What if you had to write all your code in reverse order?", type: "open", category: "philosophy", tags: ["order", "constraints", "creativity"] },
    // More Humor
    { question: "What's the most ridiculous comment you've ever seen in code?", type: "open", category: "culture", tags: ["comments", "code", "humor"] },
    { question: "If programming languages were food, which would be which?", type: "open", category: "culture", tags: ["languages", "food", "analogies"] },
    { question: "What's the most creative way you've named a variable when you were tired?", type: "open", category: "culture", tags: ["naming", "tired", "creativity"] },
    { question: "If you could make one programming error message more fun, which would it be?", type: "open", category: "culture", tags: ["errors", "messages", "fun"] },
    { question: "What's the most absurd requirement you've ever had to implement?", type: "open", category: "culture", tags: ["requirements", "absurd", "implementation"] },
    { question: "If you could add one completely useless but hilarious feature to VS Code, what would it be?", type: "open", category: "culture", tags: ["vs code", "features", "humor"] },
    { question: "What's the most creative excuse you've given for a bug?", type: "open", category: "culture", tags: ["bugs", "excuses", "creativity"] },
    { question: "If programming was a sport, what would the rules be?", type: "open", category: "culture", tags: ["sport", "rules", "programming"] },
    { question: "What's the most ridiculous thing you've googled while programming?", type: "open", category: "culture", tags: ["google", "search", "ridiculous"] },
    { question: "If you could make one programming concept into a reality TV show, which would it be?", type: "open", category: "culture", tags: ["reality tv", "concepts", "entertainment"] },
    // More Philosophy
    ...
    // More Hypotheticals
    { question: "If you could add one superpower to any programming language, what would it be?", type: "open", category: "philosophy", tags: ["superpowers", "languages", "creativity"] },
    { question: "What if every function you wrote had to be exactly 10 lines long?", type: "open", category: "philosophy", tags: ["functions", "constraints", "length"] },
    { question: "If you could only use one data type for the rest of your career, which would it be?", type: "poll", category: "philosophy", options: ["String", "Number", "Boolean", "Array", "Object"], tags: ["data types", "choice", "constraints"] },
    { question: "What if you had to program using only your voice?", type: "open", category: "philosophy", tags: ["voice", "programming", "accessibility"] },
    { question: "If you could make one programming concept completely disappear, what would it be?", type: "open", category: "philosophy", tags: ["concepts", "elimination", "frustration"] },
    { question: "What if you could only use one loop structure for the rest of your career?", type: "poll", category: "philosophy", options: ["for", "while", "forEach", "map", "reduce"], tags: ["loops", "choice", "constraints"] },
    { question: "If you had to program using only emojis as commands, how would you do it?", type: "open", category: "philosophy", tags: ["emojis", "programming", "creativity"] },
    { question: "What if every variable name had to be exactly 3 characters long?", type: "open", category: "philosophy", tags: ["naming", "constraints", "variables"] },
    { question: "If you could only use one data structure for the rest of your career, which would it be?", type: "poll", category: "philosophy", options: ["Array", "Object", "Set", "Map", "Tree"], tags: ["data structures", "choice", "constraints"] },
    { question: "What if you had to write all your code in reverse order?", type: "open", category: "philosophy", tags: ["order", "constraints", "creativity"] },
    ...
    { question: "What's the most interesting bug you've ever debugged?", type: "open", category: "personal", tags: ["bugs", "debugging", "stories"] },
    { question: "What's one programming concept you still don't fully understand?", type: "open", category: "personal", tags: ["understanding", "concepts", "learning"] },
    // Advanced Technical Debates (244-260)
    { question: "Is the 'JavaScript fatigue' real, or are developers just complaining too much?", type: "debate", category: "tech", tags: ["javascript", "fatigue", "ecosystem"] },
    { question: "Should you always use a linter, or is it sometimes overkill?", type: "debate", category: "tech", tags: ["linting", "code quality", "tools"] },
    { question: "Is the 'mobile-first' approach still relevant in 2025?", type: "debate", category: "tech", tags: ["mobile", "responsive", "design"] },
    { question: "What's the most overrated design pattern?", type: "open", category: "tech", tags: ["patterns", "design", "overrated"] },
    ...
    { question: "Is the 'test-driven development' approach always beneficial?", type: "debate", category: "tech", tags: ["tdd", "testing", "methodology"] },
    { question: "Should you always use a package manager, or is manual dependency management sometimes better?", type: "debate", category: "tech", tags: ["packages", "dependencies", "management"] },
    { question: "Is Kubernetes overkill for small applications, or is it worth learning early?", type: "debate", category: "tech", tags: ["kubernetes", "devops", "scaling"] },
    { question: "Should you always use a state management library like Redux, or is local state enough?", type: "debate", category: "tech", tags: ["state", "redux", "react"] },
    { question: "Is WebAssembly the future of web development, or just a niche tool?", type: "debate", category: "tech", tags: ["webassembly", "performance", "web"] },
    { question: "What's the most overrated JavaScript framework of 2024?", type: "open", category: "tech", tags: ["javascript", "frameworks", "overrated"] },
    { question: "Is the JAMstack architecture actually better than traditional server-side rendering?", type: "debate", category: "tech", tags: ["jamstack", "ssr", "architecture"] },
    { question: "Should you always use a CSS-in-JS solution, or is traditional CSS still viable?", type: "debate", category: "tech", tags: ["css", "styling", "js"] },
    { question: "What's the most underrated programming language that deserves more attention?", type: "open", category: "tech", tags: ["languages", "underrated", "attention"] },
    // Unique Hypothetical Scenarios (261-280)
    { question: "If you could add one superpower to any programming language, what would it be?", type: "open", category: "philosophy", tags: ["superpowers", "languages", "creativity"] },
    { question: "What if every function you wrote had to be exactly 10 lines long?", type: "open", category: "philosophy", tags: ["functions", "constraints", "length"] },
    { question: "If you could only use one data type for the rest of your career, which would it be?", type: "poll", category: "philosophy", options: ["String", "Number", "Boolean", "Array", "Object"], tags: ["data types", "choice", "constraints"] },
    { question: "What if you had to program using only your voice?", type: "open", category: "philosophy", tags: ["voice", "programming", "accessibility"] },
    ...
    { question: "If you could only use one data structure for the rest of your career, which would it be?", type: "poll", category: "philosophy", options: ["Array", "Object", "Set", "Map", "Tree"], tags: ["data structures", "choice", "constraints"] },
    { question: "What if you had to write all your code in reverse order?", type: "open", category: "philosophy", tags: ["order", "constraints", "creativity"] },
    { question: "If you could only debug using print statements forever, how would you adapt?", type: "open", category: "philosophy", tags: ["debugging", "tools", "constraints"] },
    { question: "What if every bug you wrote would physically hurt you?", type: "open", category: "philosophy", tags: ["bugs", "consequences", "humor"] },
    { question: "If you could only use one IDE for the rest of your career, which would it be?", type: "poll", category: "philosophy", options: ["VS Code", "IntelliJ", "Vim", "Sublime", "Other"], tags: ["ide", "tools", "choice"] },
    { question: "What if you had to explain every algorithm you use to a non-technical person?", type: "open", category: "philosophy", tags: ["algorithms", "explanation", "communication"] },
    { question: "If you could make one programming concept completely disappear, what would it be?", type: "open", category: "philosophy", tags: ["concepts", "elimination", "frustration"] },
    { question: "What if you could only use one design pattern for the rest of your career?", type: "poll", category: "philosophy", options: ["Singleton", "Factory", "Observer", "MVC", "Other"], tags: ["patterns", "design", "choice"] },
    { question: "If you had to program using only your non-dominant hand?", type: "open", category: "philosophy", tags: ["handedness", "programming", "constraints"] },
    { question: "What if every line of code you wrote had to be approved by a committee?", type: "open", category: "philosophy", tags: ["approval", "process", "constraints"] },
    { question: "If you could only use one programming paradigm for the rest of your career?", type: "poll", category: "philosophy", options: ["OOP", "Functional", "Procedural", "Declarative", "Other"], tags: ["paradigms", "choice", "constraints"] },
    { question: "What if you had to program using only binary code?", type: "open", category: "philosophy", tags: ["binary", "programming", "fundamentals"] },
    // More Humor & Entertainment (281-300)
    { question: "What's the most ridiculous comment you've ever seen in production code?", type: "open", category: "culture", tags: ["comments", "code", "humor"] },
    { question: "If programming languages were food, which would be which?", type: "open", category: "culture", tags: ["languages", "food", "analogies"] },
    { question: "What's the most creative way you've named a variable when you were tired?", type: "open", category: "culture", tags: ["naming", "tired", "creativity"] },
    { question: "If you could make one programming error message more fun, which would it be?", type: "open", category: "culture", tags: ["errors", "messages", "fun"] },
    { question: "What's the most absurd requirement you've ever had to implement?", type: "open", category: "culture", tags: ["requirements", "absurd", "implementation"] },
    ...
    { question: "What's the most ridiculous thing you've googled while programming?", type: "open", category: "culture", tags: ["google", "search", "ridiculous"] },
    { question: "If you could make one programming concept into a reality TV show, which would it be?", type: "open", category: "culture", tags: ["reality tv", "concepts", "entertainment"] },
    { question: "What's the most cursed variable name you've ever seen in production?", type: "open", category: "culture", tags: ["naming", "cursed", "production"] },
    { question: "If you could rename any programming term to something funnier, what would it be?", type: "open", category: "culture", tags: ["terminology", "humor", "creativity"] },
    { question: "What's the most absurd error message you've ever encountered?", type: "open", category: "culture", tags: ["errors", "messages", "humor"] },
    { question: "If you could add one completely useless but fun feature to any programming language?", type: "open", category: "culture", tags: ["features", "fun", "useless"] },
    { question: "What's the most creative way you've procrastinated while debugging?", type: "open", category: "culture", tags: ["procrastination", "debugging", "creativity"] },
    { question: "If programming languages were people, which one would be the most annoying roommate?", type: "open", category: "culture", tags: ["languages", "personality", "humor"] },
    { question: "What's the weirdest variable name you've ever seen in production code?", type: "open", category: "culture", tags: ["naming", "code", "humor"] },
    { question: "If you had to explain programming to a 5-year-old using only food analogies?", type: "open", category: "culture", tags: ["explanation", "analogies", "creativity"] },
    { question: "What's the most ridiculous requirement you've ever received from a client?", type: "open", category: "culture", tags: ["clients", "requirements", "stories"] },
    { question: "If you could make one programming concept illegal, which would it be?", type: "open", category: "culture", tags: ["concepts", "frustration", "humor"] }
];
async function seedPrompts() {
    try {
        ...
        await Prompt_1.Prompt.deleteMany({});
        // Insert new prompts
        await Prompt_1.Prompt.insertMany(prompts);
...
if (require.main === module) {
    Promise.resolve().then(() => __importStar(require('../index'))).then(() => {
        seedPrompts()
            .then(() => process.exit(0))
