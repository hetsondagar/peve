...
export async function toggleLikeIdea(req: Request, res: Response) {
  try {
    ...
    const isLiked = idea.likedBy.includes(userId as any);
    let action = '';
...
export async function toggleLikeProject(req: Request, res: Response) {
  try {
    const userId = (req as any).user?.id;
    ...
    const isLiked = project.likedBy.includes(userId as any);
    let action = '';
...
export async function getLikedByUsers(req: Request, res: Response) {
  try {
