            ...
            <CardContent className="h-72">
              {radarData.length ? (
                ...
                <p className="text-sm text-muted-foreground">
                  {insightMsg || 'Repository insights unlock the radar when GitHub is linked and ML is available.'}
                </p>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="border-border bg-card shadow-lg">
            ...
            <CardContent className="h-80">
              {intel?.architecture_space && intel.architecture_space.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground">
                  {insightMsg ||
                    'Link a GitHub repository and ensure the ML service is running to populate the embedding map.'}
                </p>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              {soul.length ? (
                ...
                <p className="text-muted-foreground">
                  Soul lines appear when repository intelligence runs (GitHub link + ML service). Tune the README and
                  topics — the model grounds copy in real metadata.
                </p>
              )}
            </CardContent>
          </Card>
